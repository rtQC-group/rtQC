...
gui_data.txt_headingA_dqchecks = uicontrol('Parent', gui_data.panel_dqchecks,...
    'Style','text',...
    'String','Offline vs Online image quality check',...
    'Units', 'Normalized',...
...
gui_data.txt_headingB_dqchecks = uicontrol('Parent', gui_data.panel_dqchecks,...
    'Style','text',...
    'String','Philips XTC-exported data quality check',...
    'Units', 'Normalized',...
    'Position',[0.02 0.2 0.96 0.05],...
    'HorizontalAlignment', 'left',...
    'fontweight', 'bold',...
